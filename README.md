...
- [kernel sync: sleepable的上下文以及会引起sleep的函数概述](https://mp.weixin.qq.com/s?__biz=Mzg2MDE3Nzg0OQ==&mid=2247484767&idx=1&sn=8d9306a0b7f88f21a2218eebe755972a)
...
- [被Linux内核用C写的kfifo无锁设计惊艳到了~](https://www.toutiao.com/article/7637737642033037876/)
...
- [Linux内核Page Cache和Buffer Cache关系及演化历史](https://www.cnblogs.com/Chary/p/18112921)
...
- 在 Windows 或 Linux 上使用 VSCode 利用 SSH 远程访问另一条 Linux 上的代码：下载插件 **`remote ssh`**。
- [人工智能开发必须掌握的那些Linux指令（高级篇）](https://mp.weixin.qq.com/s/k3XuvGMV71gmDhhhLmL23w)
- [【紧急】 Linux 史上最爆漏洞！一条命令提权到 root | CVE-2026-31431 | Copy Fail](https://www.bilibili.com/video/BV1Qf9eBEEAc/)
